...
const SYMPTOMS_LIST = [
  ...
  {key:"insomnia",emoji:"🌙",label:"Insomnia"},{key:"neck pressure",emoji:"🦢",label:"Neck"},
   ...
   {key:"travel day",emoji:"✈️",label:"Travel Day"},
...
const FOOD_DB = [
 ...
 { keys:["chicken liver"], name:"Chicken Liver (3oz)", cal:142, pro:21, carb:1, fat:5, fib:0, se:38, io:14, zn:3.0, ir:9.9, mg:20, vd:19 },
   { keys:["aperol spritz","aperoll spritz","aperol","spritz"], name:"Aperol Spritz (1 drink)", cal:160, pro:0, carb:15, fat:0, fib:0, se:0, io:0, zn:0, ir:0, mg:0, vd:0, sod:5, asug:13, mealTypes:["Snack","Dinner"] },
 ...
 { keys:["choripan","chori pan"], name:"Choripán (1)", cal:450, pro:18, carb:36, fat:26, fib:2, se:20, io:8, zn:2.5, ir:2.2, mg:22, vd:10 },
  { keys:["american airlines nuts","aa nuts","airline nuts","warm mixed nuts","nuts on clark"], name:"American Airlines Mixed Nuts (1 oz)", cal:170, pro:5, carb:6, fat:15, fib:2, se:2, io:0, zn:1, ir:1, mg:50, vd:0, sod:110, asug:0, mealTypes:["Snack"] },
 ...
 { keys:["outside skirt steak","skirt steak"], name:"Skirt Steak (6oz)", cal:350, pro:40, carb:0, fat:20, fib:0, se:26, io:8, zn:6.8, ir:3.8, mg:34, vd:8 },
  { keys:["naan","indian bread","naan bread","plain naan","butter naan"], name:"Naan (Indian bread, 1 piece)", cal:280, pro:9, carb:50, fat:5, fib:2, se:15, io:0, zn:0.7, ir:2.5, mg:20, vd:0, sod:450, asug:2, mealTypes:["Lunch","Dinner"] },
  { keys:["lamb curry","lamb with sauce","lamb in sauce","lamb masala","rogan josh","indian lamb curry"], name:"Lamb Curry (generic)", cal:540, pro:34, carb:14, fat:37, fib:3, se:28, io:5, zn:6, ir:4, mg:40, vd:0, sod:900, asug:3, mealTypes:["Lunch","Dinner"] },
 ...
 { keys:["lettuce and tomato salad","lettuce tomato salad","lettuce and tomato"], name:"Lettuce & Tomato Salad", cal:35, pro:1.5, carb:7, fat:0.3, fib:2.5, se:0.2, io:0, zn:0.3, ir:0.6, mg:18, vd:0 },
  { keys:["habanero","habanero pepper","habaneros"], name:"Habanero Pepper (1 pepper)", cal:2, pro:0, carb:0.4, fat:0, fib:0.1, se:0, io:0, zn:0, ir:0.1, mg:1, vd:0, sod:0, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["shishito","shishito peppers","shishito pepper"], name:"Shishito Peppers (1 cup)", cal:10, pro:0.4, carb:2.3, fat:0.1, fib:0.8, se:0, io:0, zn:0.1, ir:0.2, mg:4, vd:0, sod:1, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["oyster mushroom","oyster mushrooms"], name:"Oyster Mushrooms (1 cup)", cal:28, pro:2.9, carb:5, fat:0.3, fib:2, se:2.2, io:0, zn:0.7, ir:1.1, mg:15, vd:0, sod:15, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["blue oyster mushroom","blue oyster mushrooms","blue oyster"], name:"Blue Oyster Mushrooms (1 cup)", cal:28, pro:2.9, carb:5, fat:0.3, fib:2, se:2.2, io:0, zn:0.7, ir:1.1, mg:15, vd:0, sod:15, asug:0, mealTypes:["Lunch","Dinner"] },
  { name:"Turmeric Root (fresh, 1 tbsp grated)", unit:"1 tbsp", keys:["turmeric root","fresh turmeric","turmeric fresh"], cal:8, pro:0.2, carb:1.6, fat:0.2, fib:0.5, se:0.1, io:0, zn:0.2, ir:1.0, mg:3, vd:0 },
 ...
 { keys:["pork chop","pork","pork loin","pork tenderloin"], name:"Pork (4oz)", cal:220, pro:29, carb:0, fat:11, fib:0, se:38, io:5, zn:2.5, ir:0.9, mg:26, vd:20 },
  { keys:["airline chicken and rice","american airlines chicken rice","airline chicken rice","chicken rice airline meal","aa chicken rice"], name:"Chicken & Rice, airline meal (est.)", cal:480, pro:35, carb:48, fat:15, fib:3, se:28, io:5, zn:1.5, ir:1.8, mg:45, vd:0, sod:950, asug:3, mealTypes:["Lunch","Dinner"] },
 ...
 { keys:["cherry","cherries"], name:"Cherries (1 cup)", cal:95, pro:2, carb:24, fat:0, fib:3, se:0, io:0, zn:0.1, ir:0.5, mg:15, vd:0 },
  { keys:["idli","idly","steamed rice cake"], name:"Idli (2 pieces)", cal:130, pro:4, carb:26, fat:0.5, fib:1, se:2, io:0, zn:0.4, ir:0.8, mg:18, vd:0, sod:280, asug:0, mealTypes:["Breakfast"] },
  { keys:["dosa","plain dosa","masala dosa"], name:"Dosa (1 plain)", cal:170, pro:4, carb:32, fat:3, fib:1.5, se:2, io:0, zn:0.5, ir:1, mg:20, vd:0, sod:350, asug:0, mealTypes:["Breakfast","Lunch"] },
  { keys:["sambar","sambar soup","lentil sambar"], name:"Sambar (1 cup)", cal:90, pro:5, carb:14, fat:2, fib:4, se:1, io:0, zn:0.8, ir:2, mg:30, vd:0, sod:500, asug:0, mealTypes:["Breakfast","Lunch","Dinner"] },
  { keys:["upma","rava upma","semolina upma"], name:"Upma (1 cup)", cal:220, pro:5, carb:38, fat:6, fib:3, se:3, io:0, zn:0.6, ir:1.5, mg:25, vd:0, sod:400, asug:0, mealTypes:["Breakfast"] },
  { keys:["poha","aloo poha","flattened rice"], name:"Poha (1 cup)", cal:180, pro:3, carb:35, fat:4, fib:2, se:1, io:0, zn:0.5, ir:1.8, mg:20, vd:0, sod:300, asug:0, mealTypes:["Breakfast","Snack"] },
    { keys:["chicken lo mein","lo mein chicken","chicken noodles lo mein"], name:"Chicken Lo Mein (1 cup)", cal:310, pro:16, carb:40, fat:9, fib:2, se:18, io:3, zn:1.2, ir:1.5, mg:30, vd:0, sod:900, asug:2, mealTypes:["Lunch","Dinner"] },
  { keys:["beef lo mein","lo mein beef","beef noodles lo mein"], name:"Beef Lo Mein (1 cup)", cal:340, pro:18, carb:40, fat:11, fib:2, se:20, io:2, zn:3.5, ir:2.5, mg:32, vd:0, sod:950, asug:2, mealTypes:["Lunch","Dinner"] },
  { keys:["aloo paratha","potato paratha","stuffed paratha"], name:"Aloo Paratha (1 piece)", cal:260, pro:5, carb:38, fat:10, fib:3, se:5, io:0, zn:0.7, ir:1.8, mg:28, vd:0, sod:380, asug:0, mealTypes:["Breakfast","Lunch"] },
  { keys:["masala chai","chai","indian chai","masala tea"], name:"Masala Chai (1 cup, with milk)", cal:80, pro:2.5, carb:12, fat:2.5, fib:0, se:1, io:10, zn:0.3, ir:0.2, mg:10, vd:0, sod:50, asug:8, mealTypes:["Breakfast","Snack"] },
  { keys:["chole","chhole","chodni","chickpea curry","chole curry","chana masala"], name:"Chole (spiced chickpea curry, 1 cup)", cal:270, pro:12, carb:42, fat:7, fib:11, se:3, io:0, zn:1.8, ir:4.5, mg:60, vd:0, sod:700, asug:0, mealTypes:["Breakfast","Lunch","Dinner"] },
  { keys:["ragda","gooli","white peas curry","ragda pattice","ragda curry"], name:"Ragda (white peas curry, 1 cup)", cal:220, pro:10, carb:38, fat:4, fib:8, se:2, io:0, zn:1.5, ir:3.5, mg:50, vd:0, sod:600, asug:0, mealTypes:["Breakfast","Lunch","Snack"] },
  { keys:["samosa","vegetable samosa","potato samosa","samosas"], name:"Samosa (1 piece)", cal:150, pro:3, carb:19, fat:7, fib:2, se:1, io:0, zn:0.3, ir:0.8, mg:15, vd:0, sod:280, asug:0, mealTypes:["Snack","Lunch","Dinner"] },
  { keys:["cathay shrimp wonton noodle soup","shrimp wonton noodle soup cathay","cathay wonton noodle soup","cathay noodle soup"], name:"Shrimp Wonton Noodle Soup, Cathay business", cal:320, pro:18, carb:42, fat:7, fib:3, se:22, io:18, zn:1.5, ir:1.5, mg:35, vd:0, sod:980, asug:1, mealTypes:["Lunch","Dinner"] },
  { keys:["cathay congee","cathay chicken congee","chicken mushroom congee cathay","congee cathay"], name:"Chicken & Mushroom Congee, Cathay business", cal:220, pro:14, carb:32, fat:4, fib:1, se:12, io:3, zn:1.2, ir:1, mg:25, vd:0, sod:750, asug:0, mealTypes:["Breakfast","Lunch"] },
  { keys:["kiwi"], name:"Kiwi (2)", cal:90, pro:2, carb:22, fat:1, fib:4, se:0.2, io:0, zn:0.2, ir:0.6, mg:26, vd:0 },
  { keys:["golden oyster mushroom","golden oyster","gold mushroom","golden mushroom","gold oyster mushroom"], name:"Golden Oyster Mushrooms (1 cup)", cal:28, pro:2.9, carb:5, fat:0.3, fib:2, se:2.2, io:0, zn:0.7, ir:1.1, mg:15, vd:0, sod:15, asug:0, mealTypes:["Lunch","Dinner"] },
    { keys:["mushroom flatbread","mushroom flat bread","flatbread"], name:"Mushroom Flatbread (generic, whole)", cal:680, pro:27, carb:60, fat:33, fib:4, se:20, io:15, zn:2.5, ir:3, mg:45, vd:0, sod:1100, asug:2, mealTypes:["Lunch","Dinner"] },
  { keys:["snow oyster","snow oyster mushroom","white oyster mushroom"], name:"Snow Oyster Mushrooms (1 cup)", cal:28, pro:2.9, carb:5, fat:0.3, fib:2, se:2.2, io:0, zn:0.7, ir:1.1, mg:15, vd:0, sod:15, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["king trumpet","king trumpet mushroom","king oyster","king oyster mushroom","eryngii"], name:"King Trumpet Mushrooms (1 cup)", cal:35, pro:3.3, carb:6, fat:0.4, fib:2.5, se:2.5, io:0, zn:0.8, ir:1.2, mg:17, vd:0, sod:17, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["black pearl","black pearl mushroom","black pearl king oyster","black pearl oyster"], name:"Black Pearl Mushrooms (1 cup)", cal:35, pro:3.3, carb:6, fat:0.4, fib:2.5, se:2.5, io:0, zn:0.8, ir:1.2, mg:17, vd:0, sod:17, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["chestnut mushroom","chestnut mushrooms"], name:"Chestnut Mushrooms (1 cup)", cal:16, pro:1.8, carb:3, fat:0.1, fib:0.5, se:15, io:0, zn:0.8, ir:0.3, mg:7, vd:0, sod:4, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["italian brown","italian browns","italian brown mushroom","cremini","crimini","baby bella"], name:"Italian Brown Mushrooms (1 cup)", cal:16, pro:1.8, carb:3, fat:0.1, fib:0.5, se:15, io:0, zn:0.8, ir:0.3, mg:7, vd:0, sod:4, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["spelt flour","spelt"], name:"Spelt Flour (1 cup)", cal:405, pro:18, carb:84, fat:3, fib:13, se:14, io:0, zn:3.6, ir:5.3, mg:163, vd:0, sod:10, asug:0, mealTypes:["Breakfast","Lunch","Dinner"] },
 ...
 { keys:["fig","figs"], name:"Figs (2)", cal:74, pro:1, carb:19, fat:0, fib:3, se:0.2, io:0, zn:0.2, ir:0.4, mg:14, vd:0 },
   { keys:["seafood ceviche","ceviche","fish ceviche","shrimp ceviche"], name:"Seafood Ceviche (1 cup)", cal:140, pro:24, carb:8, fat:2, fib:1.5, se:50, io:60, zn:1.5, ir:1.5, mg:40, vd:15, sod:500, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["panera you pick two","panera frontega you pick two","frontega chicken noodle you pick two","panera you pick 2 frontega"], name:"Panera You Pick 2: ½ Frontega Chicken + Chicken Noodle Cup", cal:510, pro:33, carb:49, fat:22, fib:3, se:28, io:10, zn:2.5, ir:3.5, mg:45, vd:5, sod:2340, asug:1, mealTypes:["Lunch","Dinner"] },
  { keys:["seasons 52 filet mignon","filet mignon seasons 52","seasons 52 filet","filet mignon asparagus"], name:"Filet Mignon w/ Asparagus (Seasons 52, 6oz)", cal:520, pro:45, carb:24, fat:28, fib:5, se:32, io:8, zn:9, ir:4.5, mg:50, vd:8, sod:1500, asug:2, mealTypes:["Lunch","Dinner"] },
  { keys:["fried calamari","calamari","fried squid"], name:"Fried Calamari (appetizer)", cal:310, pro:18, carb:16, fat:18, fib:1, se:45, io:25, zn:1.8, ir:1.2, mg:33, vd:0, sod:600, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["dates"], name:"Dates (3)", cal:200, pro:2, carb:54, fat:0, fib:5, se:0.2, io:0, zn:0.2, ir:0.9, mg:38, vd:0 },
  { keys:["seafood risotto","frutti di mare risotto","risotto frutti di mare","risotto seafood"], name:"Seafood Risotto (Frutti di Mare)", cal:650, pro:34, carb:73, fat:23, fib:3, se:60, io:130, zn:3, ir:7, mg:55, vd:20, sod:1200, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["pomegranate"], name:"Pomegranate (½)", cal:70, pro:1, carb:17, fat:1, fib:4, se:0.5, io:0, zn:0.4, ir:0.3, mg:10, vd:0 },
  { keys:["zucchini","green zucchini","courgette"], name:"Zucchini, Green (1 cup)", cal:20, pro:1.5, carb:4, fat:0, fib:1, se:0.2, io:0, zn:0.3, ir:0.4, mg:18, vd:0, sod:10, asug:0 },
  { keys:["yellow zucchini","yellow squash","summer squash"], name:"Zucchini, Yellow (1 cup)", cal:20, pro:1.5, carb:4.2, fat:0.3, fib:1.4, se:0.2, io:0, zn:0.4, ir:0.5, mg:21, vd:0, sod:2, asug:0 },
  { keys:["lemon"], name:"Lemon", cal:17, pro:1, carb:5, fat:0, fib:2, se:0.4, io:0, zn:0.1, ir:0.4, mg:7, vd:0 },
  { keys:["cathay rice with pork","rice with pork cathay","cathay pork rice","braised pork rice cathay"], name:"Rice with Pork, Cathay business (est.)", cal:550, pro:30, carb:50, fat:24, fib:2, se:25, io:5, zn:2.5, ir:2, mg:45, vd:0, sod:1100, asug:5, mealTypes:["Lunch","Dinner"] },
  { keys:["cathay stir fry noodles","stir fried noodles cathay","cathay stir fried noodles","cathay noodles"], name:"Stir-Fried Noodles, Cathay business (est.)", cal:500, pro:24, carb:62, fat:15, fib:3, se:20, io:3, zn:2, ir:2.5, mg:40, vd:0, sod:1200, asug:4, mealTypes:["Lunch","Dinner"] },
 ...
 { keys:["raisin","raisins","sultana"], name:"Raisins (¼ cup)", cal:120, pro:1, carb:32, fat:0, fib:1, se:0.1, io:0, zn:0.1, ir:0.8, mg:10, vd:0 },
  { keys:["minestrone","minestrone soup","vegetable minestrone"], name:"Minestrone Soup (1.5 cups)", cal:170, pro:7, carb:28, fat:4.5, fib:6, se:4, io:2, zn:1, ir:2.2, mg:42, vd:0, sod:900, asug:0, mealTypes:["Lunch","Dinner"] },
  { keys:["spinach","baby spinach"], name:"Spinach (2 cups)", cal:14, pro:2, carb:2, fat:0, fib:1.4, se:0.6, io:0, zn:0.3, ir:1.6, mg:47, vd:0 },
  { keys:["kale","baby kale","curly kale","lacinato kale","tuscan kale"], name:"Kale (1 cup chopped)", cal:7, pro:0.6, carb:1, fat:0.1, fib:0.9, se:0.2, io:0, zn:0.1, ir:0.3, mg:7, vd:0, sod:11, asug:0, mealTypes:["Breakfast","Lunch","Dinner"] },
  { keys:["feta cheese","feta crumbles","crumbled feta","feta tbsp","feta"], name:"Feta Cheese (1 tbsp)", cal:26, pro:1.4, carb:0.4, fat:2.1, fib:0, se:1.5, io:4, zn:0.3, ir:0.1, mg:2, vd:0, sod:110, asug:0, mealTypes:["Breakfast","Lunch","Dinner"] },
 ...
 { keys:["pictsweet","roasted veggies","roasted vegetables","vegetables for roasting","broccoli potato carrot roast","roasted veggie blend"], name:"Roasted Veggies (Pictsweet, 1 cup)", cal:70, pro:2, carb:12, fat:1, fib:2, se:1, io:3, zn:0.4, ir:0.7, mg:25, vd:0 },
  ...
  { keys:["seasons 52 beef tacos","seasons 52 steak tacos","beef tacos seasons 52","wood-grilled steak tacos","seasons 52 tacos"], name:"Wood-Grilled Steak Tacos (Seasons 52)", cal:500, pro:31, carb:48, fat:22, fib:10, se:25, io:3, zn:5, ir:4, mg:60, vd:0, sod:1490, asug:3, mealTypes:["Lunch","Dinner"] },
  { keys:["seasons 52 lobster bisque","lobster bisque seasons 52","seasons 52 lobster bisque cup","lobster bisque cup"], name:"Lobster Bisque, Cup (Seasons 52)", cal:200, pro:5, carb:15, fat:12, fib:0, se:15, io:20, zn:1, ir:0.5, mg:15, vd:0, sod:920, asug:2, mealTypes:["Lunch","Dinner"] },
 ...
 { keys:["bell pepper","red pepper","green pepper"], name:"Bell Pepper (1 cup)", cal:46, pro:1, carb:9, fat:0, fib:3, se:0.1, io:0, zn:0.3, ir:0.5, mg:12, vd:0 },
  { keys:["sweet red pepper","red bell pepper","sweet red bell pepper"], name:"Sweet Red Pepper (1 medium)", cal:37, pro:1.2, carb:7, fat:0.4, fib:2.5, se:0.1, io:0, zn:0.3, ir:0.5, mg:14, vd:0, sod:5, asug:0, mealTypes:["Breakfast","Lunch","Dinner"] },
  { keys:["sweet green pepper","green bell pepper","sweet green bell pepper"], name:"Sweet Green Pepper (1 medium)", cal:24, pro:1.1, carb:5.5, fat:0.2, fib:2, se:0, io:0, zn:0.2, ir:0.4, mg:12, vd:0, sod:4, asug:0, mealTypes:["Breakfast","Lunch","Dinner"] },
  { keys:["pimientos de padron","padron peppers","pimientos padron","padron","blistered padron"], name:"Pimientos de Padron (pan, salt & olive oil)", cal:150, pro:1, carb:5, fat:14, fib:1.5, se:0.2, io:0, zn:0.2, ir:0.5, mg:12, vd:0, sod:300, asug:0, mealTypes:["Lunch","Dinner"] },
 ...
 { keys:["pea","peas","green peas"], name:"Green Peas (½ cup)", cal:62, pro:4, carb:11, fat:0, fib:4, se:1.8, io:0, zn:0.6, ir:1.2, mg:26, vd:0 },
    { keys:["cheese quesadilla","quesadilla"], name:"Cheese Quesadilla", cal:585, pro:27, carb:39, fat:37, fib:2, se:27, io:30, zn:3.1, ir:2.4, mg:34, vd:10, sod:1030, asug:0, mealTypes:["Lunch","Dinner"] },
...
{ keys:["snap pea","snap peas","sugar snap peas"], name:"Snap Peas, raw (1 cup)", cal:41, pro:3, carb:7, fat:0, fib:3, se:0.3, io:0, zn:0.3, ir:1.1, mg:12, vd:0 },
 ...
 { keys:["american blend","american blend lettuce","american salad blend","salad blend"], name:"American Blend Lettuce (2 cups)", cal:15, pro:1, carb:3, fat:0, fib:1.5, se:0.2, io:0, zn:0.2, ir:0.5, mg:10, vd:0 },
  { keys:["mushroom medley","sauteed mushrooms","mushroom side","garlic butter mushrooms"], name:"Mushroom Medley (side serving)", cal:185, pro:2.3, carb:5, fat:17, fib:1, se:6, io:0, zn:0.4, ir:0.5, mg:10, vd:10, sod:235, asug:0, mealTypes:["Lunch","Dinner"] },
 ...
 { keys:["brazil nut","brazil nuts"], name:"Brazil Nuts (1oz)", cal:185, pro:4, carb:3, fat:19, fib:2, se:544, io:1, zn:1.2, ir:0.7, mg:107, vd:0 },
   { keys:["almond","almonds"], name:"Almonds (1 tbsp)", cal:52, pro:1.9, carb:1.9, fat:4.4, fib:1.1, se:0.3, io:0, zn:0.3, ir:0.35, mg:24, vd:0, sod:0, asug:0 },
  { keys:["sunflower seed"], name:"Sunflower Seeds (1 tbsp)", cal:52, pro:1.9, carb:2.2, fat:4.4, fib:1, se:7.3, io:0, zn:0.5, ir:0.5, mg:12, vd:0, sod:0, asug:0 },
 ...
 { keys:["white toast","white bread","toast"], name:"White Toast (2sl)", cal:140, pro:5, carb:26, fat:2, fib:1, se:10, io:4, zn:0.5, ir:1.5, mg:15, vd:0 },
  { keys:["cooked kale","kale cooked","steamed kale","sauteed kale","braised kale"], name:"Kale, Cooked (1 cup)", cal:36, pro:2.5, carb:7, fat:0.5, fib:2.6, se:0.9, io:0, zn:0.3, ir:1.2, mg:30, vd:0, sod:30, asug:0, mealTypes:["Lunch","Dinner"] },
  { name:"Avocado Oil", unit:"1 tbsp", keys:["avocado oil"], cal:124, pro:0, carb:0, fat:14, fib:0, se:0, io:0, zn:0, ir:0, mg:0, vd:0 },
...
{ keys:["salmon fillet","salmon"], name:"Salmon Fillet (6oz)", cal:350, pro:37, carb:0, fat:22, fib:0, se:62, io:34, zn:0.9, ir:1.2, mg:49, vd:950 },
{ keys:["steelhead trout","steelhead"], name:"Steelhead Trout Fillet (6oz)", cal:300, pro:35, carb:0, fat:15, fib:0, se:45, io:25, zn:0.7, ir:0.8, mg:45, vd:700 },
{ keys:["rainbow trout","trout fillet"], name:"Rainbow Trout Fillet (~5oz)", cal:214, pro:33, carb:0, fat:8.5, fib:0, se:19, io:20, zn:0.5, ir:0.5, mg:44, vd:300 },
{ keys:["tuna fillet","tuna steak"], name:"Tuna Fillet (6oz)", cal:220, pro:49, carb:0, fat:1.7, fib:0, se:150, io:29, zn:0.8, ir:1.7, mg:85, vd:80 },
{ keys:["maggi seasoning tbsp","maggi tbsp"], name:"Maggi Seasoning (1 tbsp)", cal:10, pro:1.5, carb:1, fat:0, fib:0, se:0, io:0, zn:0, ir:0, mg:0, vd:0 },
...
{ keys:["grey poupon","dijon mustard","mustard"], name:"Grey Poupon Dijon Mustard (1 tsp)", cal:5, pro:0, carb:0.4, fat:0.3, fib:0.1, se:0.4, io:0, zn:0, ir:0.1, mg:1, vd:0 },
...
{ keys:["oats tbsp","tbsp oats","raw oats"], name:"Oats (1 tbsp)", cal:20, pro:1, carb:3, fat:0.4, fib:0.5, se:0.4, io:0, zn:0.1, ir:0.2, mg:6, vd:0 },
  { keys:["chia seeds","chia"], name:"Chia Seeds (1 tbsp)", cal:58, pro:2, carb:5, fat:3.7, fib:4, se:0.9, io:0, zn:0.5, ir:0.9, mg:33, vd:0, sod:2, asug:0 },
{ keys:["wurze seasoning","maggi wurze","wurze"], name:"Maggi Würze Seasoning (1 tsp)", cal:3, pro:0.5, carb:0.3, fat:0, fib:0, se:0, io:0, zn:0, ir:0, mg:0, vd:0 },
   { keys:["balsamic honey vinaigrette","honey balsamic vinaigrette","balsamic vinaigrette","honey balsamic dressing"], name:"Balsamic Honey Vinaigrette (2 tbsp)", cal:150, pro:0.5, carb:6.5, fat:14, fib:0.3, se:2.5, io:0, zn:0.1, ir:0.3, mg:5, vd:0, sod:150, asug:4.3, mealTypes:["Lunch","Dinner"] },
...
{ keys:["beef milanesa", "milanesa de carne", "milanesa"], name:"Beef Milanesa (Baked, Top Sirloin)", cal:280, pro:32, carb:16, fat:11, fib:1, se:25, io:5, zn:4.8, ir:2.6, mg:24, vd:0.2 },
 { keys:["cappuccino", "small cappuccino"], name:"Cappuccino (Small, Whole Milk)", cal:80, pro:4, carb:6, fat:4.5, fib:0, se:2, io:3, zn:0.4, ir:0.05, mg:10, vd:0.3 },
{ keys:["ham olive pepper pizza", "supreme pizza", "ham green olive pepper pizza"], name:"Cheese Pizza w/ Ham, Green Olives & Peppers (1 slice)", cal:260, pro:13, carb:28, fat:11, fib:2, se:18, io:10, zn:1.4, ir:1.7, mg:20, vd:0.2 },
{ keys:["cheese pizza", "cheese pizza slice", "pizza slice"], name:"Cheese Pizza (1 thin-crust slice)", cal:220, pro:10, carb:26, fat:8, fib:1.5, se:15, io:10, zn:1.2, ir:1.6, mg:18, vd:0.2 },
{ keys:["chicken nuggets", "chicken nugget"], name:"Chicken Nuggets (4 pieces, Frozen, Oven-Baked)", cal:190, pro:11, carb:13, fat:11, fib:0.8, se:14, io:4, zn:0.9, ir:0.7, mg:14, vd:0.1 },
...
{ keys:["strawberry liquid yogurt", "liquid yogurt strawberry", "drinkable yogurt strawberry"], name:"Strawberry Liquid Yogurt (Small Bottle)", cal:110, pro:3, carb:20, fat:2, fib:0, se:5, io:20, zn:0.5, ir:0.1, mg:12, vd:0 },
  { keys:["red salami", "salami"], name:"Red Salami (4-5 slices)", cal:180, pro:9, carb:1, fat:15, fib:0, se:8, io:2, zn:1.2, ir:0.6, mg:8, vd:0.2 },
    { keys:["seasons 52 summer corn soup","summer corn soup","seasons 52 corn soup","corn soup"], name:"Summer Corn Soup (Seasons 52, cup)", cal:200, pro:5, carb:34, fat:7, fib:3, se:2, io:10, zn:0.7, ir:0.8, mg:30, vd:0, sod:1000, asug:2, mealTypes:["Lunch","Dinner"] },
  { keys:["seasons 52 lamb","kona crusted lamb loin","seasons 52 lamb loin","kona lamb","lamb loin"], name:"Kona-Crusted Lamb Loin (Seasons 52)", cal:520, pro:44, carb:41, fat:19, fib:6, se:25, io:2, zn:5, ir:3.5, mg:50, vd:0, sod:1730, asug:6, mealTypes:["Lunch","Dinner"] },
  { keys:["seasons 52 pork chop","wood-grilled pork chop","seasons 52 dry-rubbed pork chop","pork chop seasons 52","dry-rubbed pork chop","pork chop mushrooms seasons 52"], name:"Wood-Grilled Dry-Rubbed Pork Chop w/ Mushrooms (Seasons 52)", cal:540, pro:35, carb:55, fat:21, fib:5, se:48, io:6, zn:3.5, ir:1.5, mg:42, vd:20, sod:610, asug:44, mealTypes:["Lunch","Dinner"] },
  { keys:["salmon eggs benedict","salmon egg benedict","salmon benedict"], name:"Salmon Eggs Benedict", cal:630, pro:40, carb:27, fat:39, fib:2, se:70, io:60, zn:2.4, ir:4, mg:50, vd:590, sod:580, asug:0, mealTypes:["Breakfast"] },
   { keys:["spirulina tablets","spirulina tabs"], name:"Spirulina (8 tablets)", cal:6, pro:1.1, carb:0.5, fat:0.16, fib:0.1, se:0.1, io:0, zn:0.04, ir:0.57, mg:3.9, vd:0, sod:10, asug:0 },
    { keys:["pumpkin seeds","pepitas","pumpkin seed"], name:"Pumpkin Seeds (1 tbsp)", cal:45, pro:2.5, carb:1, fat:4, fib:0.5, se:0.7, io:0, zn:0.6, ir:0.7, mg:46, vd:0, sod:0, asug:0 },
  { keys:["moringa","moringa powder"], name:"Moringa Powder (1 tsp)", cal:4, pro:0.5, carb:0.8, fat:0, fib:0.4, se:0, io:0, zn:0.06, ir:0.57, mg:8, vd:0, sod:0, asug:0 },
   { keys:["spirulina","spirulina powder"], name:"Spirulina (1 tsp)", cal:8, pro:1.7, carb:0.55, fat:0.2, fib:0.1, se:0.2, io:0, zn:0.05, ir:0.65, mg:6, vd:0, sod:15, asug:0 },
  { keys:["chlorella","chlorella powder"], name:"Chlorella (1 tsp)", cal:9, pro:1.3, carb:0.5, fat:0.25, fib:0.3, se:0, io:0, zn:0.16, ir:3, mg:7, vd:0, sod:0, asug:0 },
  { keys:["chlorella tablets","chlorella tabs"], name:"Chlorella (8 tablets)", cal:8, pro:1.2, carb:0.5, fat:0.18, fib:0.1, se:0.1, io:1, zn:0.14, ir:2.6, mg:6.3, vd:0, sod:0, asug:0 },
  { keys:["lutz power fruit smoothie","lutz power smoothie","lutz fruit smoothie","power fruit smoothie"], name:"Lutz Power Fruit Smoothie", cal:790, pro:50, carb:106, fat:24, fib:18, se:28, io:87, zn:4, ir:10, mg:220, vd:180, sod:200, asug:0, mealTypes:["Breakfast","Snack"] },
...
const SEASONINGS_REF = [
  ...
  { name:"Coriander (ground)", unit:"1 tbsp", keys:["coriander","ground coriander"], cal:15, pro:0.6, carb:2.8, fat:0.9, fib:2.1, se:0.1, io:0, zn:0.2, ir:0.8, mg:16, vd:0 },
    { keys:["full shallot","whole shallot","1 shallot","shallot","shallots"], name:"Shallot (whole)", cal:29, pro:1, carb:6.7, fat:0, fib:1.3, se:0.5, io:0, zn:0.2, ir:0.5, mg:8, vd:0, sod:5, asug:0 },
  { keys:["half shallot","half a shallot","1/2 shallot"], name:"Shallot (½)", cal:14, pro:0.5, carb:3.4, fat:0, fib:0.6, se:0.2, io:0, zn:0.1, ir:0.2, mg:4, vd:0, sod:2, asug:0 },
  { keys:["minced shallot","shallot minced"], name:"Shallot (1 tbsp minced)", cal:7, pro:0.3, carb:1.7, fat:0, fib:0.3, se:0.1, io:0, zn:0, ir:0.1, mg:2, vd:0, sod:1, asug:0 },
